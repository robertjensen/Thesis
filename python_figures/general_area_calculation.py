...
#cursor.execute("SELECT x/1000,y*1e9 FROM xy_values_microreactor where measurement = 6910")
#cursor.execute("SELECT x/1000,y*1e9 FROM xy_values_microreactor where measurement = 6921")
cursor.execute("SELECT x/1000,y*1e9 FROM xy_values_microreactor where measurement = 6932")
...
#cursor.execute("SELECT x/1000,y FROM xy_values_microreactor where measurement = 6916")
#cursor.execute("SELECT x/1000,y FROM xy_values_microreactor where measurement = 6927")
cursor.execute("SELECT x/1000,y FROM xy_values_microreactor where measurement = 6938")
...
#for i in range(0,4):
    axis_array.append(fig.add_subplot(5,4,i+1))
    start = times[i]+90
    end = times[i]+200

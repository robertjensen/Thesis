...
if __name__ == '__main__':
    ...
    axis.set_xlim(0,75)
    #axis.set_ylim(-20,20)
    axis.set_xlabel('Mass / amu', fontsize=d.x_axis_font)
    axis.set_ylabel('Error / ns', fontsize=d.y_axis_font)
    ...
    axis.set_xlabel('Mass / amu', fontsize=d.x_axis_font)
    axis.set_ylabel('Error / milli-amu', fontsize=d.y_axis_font)
    axis.set_yticks([-50,0,50,100,150])
    axis.tick_params(direction='in', length=d.ticklength, width=2, colors='k',labelsize=d.labelsize,axis='both',pad=d.pad)

    
    plt.savefig('../../svg_figures/model_error.svg')
    #plt.show()

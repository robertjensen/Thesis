...
axis2.set_ylabel('TOF / s$^{-1}$', fontsize=d.y_axis_font)
...
axis2_sub.set_ylabel('TOF/area / s$^{-1}$ $\cdot$ ($\mu$m)$^{-2}$', fontsize=d.y_axis_font)
...
axis2.set_ylabel('Prefactor / s$^{-1}$.', fontsize=d.y_axis_font)
